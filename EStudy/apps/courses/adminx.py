...
from .models import Course, Lesson, Video, CourseResource, CourseTag, BannerCourse
...
class CourseAdmin(object):
    list_display = ["name", "desc", "detail", "learn_times", "degree", "students"]
    search_fields = ["name", "desc", "detail", "degree", "students"]
    list_filter = ["name", "teacher__name", "desc", "detail", "learn_times", "degree", "students"]
    list_editable = ["degree", "desc"]


class BannerCourseAdmin(object):
    list_display = ["name", "desc", "detail", "learn_times", "degree", "students", "go_to", "show_image"]
    search_fields = ["name", "desc", "detail", "degree", "students"]
    list_filter = ["name", "teacher__name", "desc", "detail", "learn_times", "degree", "students"]
    list_editable = ["degree", "desc"]
