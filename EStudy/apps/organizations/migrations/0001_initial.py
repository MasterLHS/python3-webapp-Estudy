# Generated by Django 2.2.4 on 2019-09-09 12:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('work_company', models.CharField(max_length=50, verbose_name='就只公司')),
                ('work_position', models.CharField(max_length=50, verbose_name='公司职位')),
                ('points', models.CharField(max_length=50, verbose_name='教学特点')),
                ('click_nums', models.IntegerField(default=0, verbose_name='点击数')),
                ('fav_nums', models.IntegerField(default=0, verbose_name='收藏数')),
                ('age', models.IntegerField(default=20, verbose_name='年龄')),
                ('image', models.ImageField(default='', upload_to='techter/%Y/%m', verbose_name='头像')),
